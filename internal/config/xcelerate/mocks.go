...
// Ensure, that MockConfig does implement Config.
...
func (mock *MockConfig) GetBuildCacheEnabled() bool {
	if mock.GetBuildCacheEnabledFunc == nil {
		panic("MockConfig.GetBuildCacheEnabledFunc: method is nil but Config.GetBuildCacheEnabled was just called")
	}
	callInfo := struct {
	}{}
...
func (mock *MockConfig) GetBuildCacheEnabledCalls() []struct {
} {
	var calls []struct {
	}
...
func (mock *MockConfig) GetOriginalXcodebuildPath() string {
	if mock.GetOriginalXcodebuildPathFunc == nil {
		panic("MockConfig.GetOriginalXcodebuildPathFunc: method is nil but Config.GetOriginalXcodebuildPath was just called")
	}
	callInfo := struct {
	}{}
...
func (mock *MockConfig) GetOriginalXcodebuildPathCalls() []struct {
} {
	var calls []struct {
	}
...
func (mock *MockConfig) GetProxyVersion() string {
	if mock.GetProxyVersionFunc == nil {
		panic("MockConfig.GetProxyVersionFunc: method is nil but Config.GetProxyVersion was just called")
	}
	callInfo := struct {
	}{}
...
func (mock *MockConfig) GetProxyVersionCalls() []struct {
} {
	var calls []struct {
	}
...
func (mock *MockConfig) GetWrapperVersion() string {
	if mock.GetWrapperVersionFunc == nil {
		panic("MockConfig.GetWrapperVersionFunc: method is nil but Config.GetWrapperVersion was just called")
	}
	callInfo := struct {
	}{}
...
func (mock *MockConfig) GetWrapperVersionCalls() []struct {
} {
	var calls []struct {
	}
...
// Save calls SaveFunc.
func (mock *MockConfig) Save(os utils.OsProxy, encoderFactory utils.EncoderFactory) error {
	if mock.SaveFunc == nil {
		panic("MockConfig.SaveFunc: method is nil but Config.Save was just called")
	}
	callInfo := struct {
		Os             utils.OsProxy
		EncoderFactory utils.EncoderFactory
...
func (mock *MockConfig) SaveCalls() []struct {
	Os             utils.OsProxy
	EncoderFactory utils.EncoderFactory
} {
	var calls []struct {
