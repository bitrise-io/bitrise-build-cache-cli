	...
	tests := []struct {
		...
		},
		{
			...
			expectNotContain: []string{
				...
				// Removed diagnostics: jar-audit, -Xlog sandbox/native-runtime probes, verbose opt-in
				"bitrise-robolectric-jar-audit",
				"robolectric-sandbox-probe",
				"robolectric-nativeruntime-probe",
				"-Xlog",
				"class+load",
				"getJavaLauncher",
