...
type StepAnalyticsTracker interface {
	...
	LogMetadataLoaded(duration time.Duration, metadataKeyType string, totalFileCount int, restoredFileCount int)
...
func (t *DefaultStepAnalyticsTracker) LogMetadataLoaded(duration time.Duration, metadataKeyType string, totalFileCount int, restoredFileCount int) {
	properties := analytics.Properties{
		"duration_ms":         duration.Milliseconds(),
