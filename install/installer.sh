...
usage() {
  this=$1
  cat <<EOF
$this: download go binaries for bitrise-io/bitrise-build-cache-cli

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/bitrise-io/bitrise-build-cache-cli/releases
...
# GAR mirror (fallback after GitHub). Repo grants public read; HTTP GET works anonymously.
