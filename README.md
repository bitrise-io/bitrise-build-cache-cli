...
Behind a restrictive egress firewall, see [`docs/network-endpoints.md`](docs/network-endpoints.md) for every Bitrise host the CLI, the Gradle plugins, Bazel, Xcode and ccache connect to — including the two non-443 ports that are easy to miss.
