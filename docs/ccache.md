...
// helper.invocationID = fresh UUID (generated by withDefaults at construction)
// helper.parentID     = resolved parent
// Note: CollectAndSendStats may override both IDs with the server's active session IDs.
